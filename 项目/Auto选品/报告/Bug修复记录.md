...
|--------|------|--------|------|----------|
| BUG-001 | 登录接口限流阈值未明确配置 | P1 | ✅ 已修复 | 2025-01-21 |
| BUG-002 | 重复支付状态处理不明确 | P1 | ✅ 已修复 | 2025-01-21 |
| BUG-003 | 邀请奖励重复邀请提示不区分状态 | P2 | ✅ 已修复 | 2025-01-21 |
| BUG-004 | JWT Token刷新机制未实现 | P2 | ✅ 已修复 | 2025-01-21 |
| BUG-005 | API版本管理未完善 | P2 | ✅ 已修复 | 2025-01-21 |
| BUG-006 | HTTP响应头暴露技术栈信息 | P2 | ✅ 已修复 | 2025-01-21 |
| BUG-007 | 邀请码格式校验缺失 | P3 | ✅ 已修复 | 2025-01-21 |
| BUG-008 | 生产环境日志级别建议 | P3 | ✅ 已修复 | 2025-01-21 |
